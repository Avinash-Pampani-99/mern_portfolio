    ...
    <div className="portfolio">
      ...
      <div className="content">
        <section className="section">
          <h2>Introduction</h2>
          <p>
            I'm Avinash Pampani, a B.Tech student with a passion for Artificial Intelligence and Machine Learning,from VIT-AP
          </p>
        </section>
        ...
        <section className="section">
          <h2>Contact</h2>
          <a href="mailto:avinashp14196@gmail.com">Email me</a>
        </section>
      </div>
    </div>
  );
